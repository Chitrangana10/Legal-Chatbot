"""Build a FAISS index from the full IPC sections export."""
...
def main() -> None:
    """Embed full IPC sections and save a FAISS index."""
    settings = get_settings()
    input_path = PROJECT_ROOT / "backend/data/raw/ipc_full.json"
